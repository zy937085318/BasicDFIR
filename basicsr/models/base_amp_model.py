...
class BaseAMPModel():
    ...
    def __init__(self, opt):
        ...
        self.schedulers = []
        self.optimizers = []
        # mixed precision training flag and scaler
        train_opt = opt.get('train', {})
        self.use_amp = train_opt.get('use_amp', False) and (self.device.type == 'cuda')
        if self.use_amp:
            try:
                print('#####################')
                print("AMP is enabled. Use torch.cuda.amp for mixed precision training.")
                print('#####################')
                ...
                self.use_amp = False
                print('#####################')
                print("Warning: torch.cuda.amp is not available, fallback to use_amp=False.")
                print('#####################')
