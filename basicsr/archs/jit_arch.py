...
from .arch_util import VisionRotaryEmbeddingFast, get_2d_sincos_pos_embed, RMSNorm
...
class BottleneckPatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, pca_dim=768, embed_dim=768, bias=True):
        ...
        self.proj1 = nn.Conv2d(in_chans, pca_dim, kernel_size=patch_size, stride=patch_size, groups=1, bias=False)
