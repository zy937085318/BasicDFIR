...
class ATD_test2(nn.Module):
    def __init__(self,
        ...
        self.conv_first = nn.Conv2d(num_in_ch*4**2, embed_dim, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        if self.upsampler == 'pixelshuffle':
            ...
            # for lightweight SR
            x = torch.nn.functional.interpolate(x, scale_factor=4, mode='bicubic')
            # x = torch.nn.functional.avg_pool2d(x, 4, stride=4)
