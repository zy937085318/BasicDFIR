...
from pnpflow.train_flow_matching_sr import FLOW_MATCHING
...
from pnpflow.dataloaders import custom_collate
...
def main():
    ...
    if args.train:
        ...
        dataset_opt = yaml_load(
            '/home/ybb/Project/BasicDFIR/options/train/PixelMeanFlow/train_PNP_swinmfir_B8_SRx2_P64_scratch.yml')[
            'datasets']
        # Dataset
        ...
        if args.model == "ot":
            generative_method = FLOW_MATCHING(model, val_dataset, device, args)
    ...
    if args.eval:
        ...
        if args.noise_type == 'laplace':
            ...
            args.save_path = os.path.join(
                args.root, 'results_sr', args.dataset, args.model, args.problem, args.method, args.eval_split)
        try:
