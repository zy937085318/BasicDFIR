# Adapted from https://github.com/mobaidoctor/med-ddpm
# The original version in med-ddpm was adapted from https://github.com/openai/guided-diffusion
...
class CheckpointFunction(th.autograd.Function):
    ...
    def forward(ctx, run_function, length, *args):
        ...
        # corrected version for flow-priors to work:
        ctx.run_function = run_function
        ctx.length = length
    ...
    def backward(ctx, *output_grads):
        ...
        # new version for flow-priors to work:
        all_saved = ctx.saved_tensors  # ✅ Retrieve saved tensors
        input_tensors = list(all_saved[:ctx.length])
        input_params = list(all_saved[ctx.length:])
