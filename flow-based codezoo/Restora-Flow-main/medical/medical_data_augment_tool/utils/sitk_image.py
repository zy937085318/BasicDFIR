...
def resample(input_image,
    ...
    #print("input size in resample: ", sitk.GetArrayFromImage(input_image).shape)
    #print("output_size in resample: ", output_size)
    resample_filter.SetInterpolator(sitk_interpolator)
    resample_filter.SetOutputSpacing(output_spacing)
    #print("output_spacing in resample: ", output_spacing)
    resample_filter.SetOutputOrigin(output_origin)
    #print("output_origin in resample: ", output_origin)
