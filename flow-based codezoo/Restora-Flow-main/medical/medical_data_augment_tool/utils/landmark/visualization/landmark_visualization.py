...
from medical_data_augment_tool.utils.io.image import write
from medical_data_augment_tool.utils.landmark.visualization.landmark_visualization_base import LandmarkVisualizationBase
from medical_data_augment_tool.utils.np_image import gallery, draw_circle, draw_line
from medical_data_augment_tool.utils.sitk_np import np_to_sitk
...
class LandmarkVisualization(LandmarkVisualizationBase):
    ...
    def visualize_landmark(self, image_canvas, landmark, color, annotation, annotation_color):
        ...
        if self.spacing is not None:
            coords = [a/b for a,b in zip(coords, self.spacing[1:])]
