...
import medical_data_augment_tool.utils.io.landmark
from medical_data_augment_tool.utils.landmark.common import Landmark
import os
from medical_data_augment_tool.datasources.datasource_base import DataSourceBase
...
class LandmarkDataSource(DataSourceBase):
    ...
    def load(self):
        ...
        # factor = (1.0 / 0.1081) / 5.0
        # for img in self.point_list:
        #    for landmark in self.point_list[img]:
        #          landmark.coords = np.round(landmark.coords / factor)
