...
from medical_data_augment_tool.datasets.debug_image_dataset import DebugImageDataset
...
class BasicDataset(DebugImageDataset):
    ...
    def __init__(self,
        ...
        print('BasicDataset is deprecated and may be removed in later versions. Use GraphDataset instead.')
        self.dim = dim
