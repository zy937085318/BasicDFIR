...
from medical_data_augment_tool.datasets.basic_dataset import BasicDataset


class ReferenceTransformationDataset(BasicDataset):
    """
    Dataset consisting of multiple data_sources, data_generators, a reference spatial transformation and an iterator.
    The reference transformation is used for all data_generators. Usually image to image networks need this dataset.
    ...
    def __init__(self,
        ...
        Initializer.
            ...
            This example has 2 data_sources and 2 data_generators. The sources and the generators are connected as follows:
        ...
        :param data_sources: dict of data_sources
        ...
        print('ReferenceTransformationDataset is deprecated and may be removed in later versions. '
              'Use GraphDataset instead.')
    ...
    def get(self, id_dict):
        ...
        for key, data_generator in self.data_generators.items():
            ...
            if hasattr(data_generator, 'get_transformation'):
