...
class InputCenterTransformBase(TranslateTransformBase):
    ...
    def get_input_center(self, **kwargs):
        ...
        #print("InputCenterToOrigin input size: ", input_size)
        #print("InputCenterToOrigin input spacing: ", input_spacing)
...
class InputCenterToOrigin(InputCenterTransformBase):
    ...
    def get(self, **kwargs):
        ...
        #print("InputCenterToOrigin input center: ", input_center)
...
class OriginToInputCenter(InputCenterTransformBase):
    ...
    def get(self, **kwargs):
        ...
        #print("OriginToInputCenter input center: ", input_center)
...
class OutputCenterTransformBase(TranslateTransformBase):
    ...
    def get_output_center(self, **kwargs):
        ...
        #print("OriginToOutputCenter output size: ", output_size)
        #print("OriginToOutputCenter output spacing: ", output_spacing)
        ...
        #print("OriginToOutputCenter input size: ", input_size)
        #print("OriginToOutputCenter input spacing: ", input_spacing)
...
class OutputCenterToOrigin(OutputCenterTransformBase):
    ...
    def get(self, **kwargs):
        ...
        #print("OutputCenterToOrigin output center: ", output_center)
...
class OriginToOutputCenter(OutputCenterTransformBase):
    ...
    def get(self, **kwargs):
        ...
        """
        output_center = self.get_output_center(**kwargs)
        #print("OriginToOutputCenter output center: ", output_center)
