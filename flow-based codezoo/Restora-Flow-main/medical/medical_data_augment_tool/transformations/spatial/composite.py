...
from medical_data_augment_tool.transformations.spatial.common import create_composite
...
class Composite(SpatialTransformBase):
    ...
    """
    def __init__(self, dim, transformations, use_deprecated_behaviour=True, *args, **kwargs):
        """
        Initializer.
