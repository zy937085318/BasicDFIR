...
class FitFixedAr(ScaleTransformBase):
    ...
    def get(self, **kwargs):
        ...
        :return: The sitk.AffineTransform().
        """
        #print("kwargs in get: ", kwargs)
        input_size, input_spacing, _, _ = self.get_image_size_spacing_direction_origin(**kwargs)
        ##print("FitFixedAr input size: ", input_size)
        #print("FitFixedAr input spacing: ", input_spacing)
        #print("FitFixedAr output size: ", self.output_size)
        #print("FitFixedAr output spacing: ", self.output_spacing)
        current_scale = []
        for i in range(self.dim):
            if self.output_size[i] is None or self.output_spacing[i] is None:
                continue
