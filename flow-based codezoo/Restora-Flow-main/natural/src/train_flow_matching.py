# Adopted from https://github.com/annegnx/PnP-Flow
...
class FLOW_MATCHING(object):
        ...
        for ep in tq:
            ...
            if ep % 20 == 0:
                ...
                torch.save(self.model.state_dict(),
                           os.path.join(self.args.save_path, 'model_{}.pt'.format(ep)))   # self.model_path

                # evaluate FID
                # fid_value = self.compute_fast_fid(2048)
                # with open(self.args.save_path + 'fid.txt', 'a') as file:
    ...
    def train(self, data_loaders):
        ...
        # self.args.root + 'results/{}/{}/ot/'.format(self.args.dataset, self.args.latent))
        try:
